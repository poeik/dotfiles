...
local neovim_home = vim.fn.getenv("HOME") .. "/.config/nvim/"

local Dictionary_file = {
    ["en-GB"] = { neovim_home .. "spell/dictionary.txt"} -- there is another way to find ~/.config/nvim ?
}
local DisabledRules_file = {
    ["en-GB"] = { neovim_home .. "spell/disable.txt"} -- there is another way to find ~/.config/nvim ?
}
local FalsePositives_file = {
    ["en-GB"] = { neovim_home .. "spell/false.txt"} -- there is another way to find ~/.config/nvim ?
}
